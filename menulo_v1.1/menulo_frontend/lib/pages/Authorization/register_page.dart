    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text(
          title,
          style: TextStyle(
            color: isActive ? AppColors.brandColor : Colors.black45,
            fontWeight: FontWeight.bold,
            fontFamily: 'Gabarito',
          ),
        ),
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: hint,
            hintStyle: const TextStyle(color: Colors.black26, fontFamily: 'Gabarito'),
        ...
        if (subText != null) ...[
          ...
          Text(subText, style: const TextStyle(color: Colors.black38, fontSize: 12, fontFamily: 'Gabarito')),
        ]
      ],
    );
  }
