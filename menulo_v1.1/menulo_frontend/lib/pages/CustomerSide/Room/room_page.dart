...
class _RoomPageState extends State<RoomPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.ios_share, color: AppColors.brandColor),
            onPressed: () {},
          ),
              ...
              children: [
                SliderTheme(
                  data: SliderTheme.of(context).copyWith(
                    ...
                    overlayColor: AppColors.brandColor.withOpacity(0.2),
                    valueIndicatorColor: AppColors.brandColor,
  ...
  Widget _foodChip(String label) {
    ...
    return ChoiceChip(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(10),
        side: BorderSide(color: isSelected ? AppColors.brandColor : Colors.grey.shade300),
      ),
  ...
  Widget _addButton() {
    return Container(
      ...
      child: const Icon(Icons.add, size: 19, color: AppColors.brandColor),
    );
  }
